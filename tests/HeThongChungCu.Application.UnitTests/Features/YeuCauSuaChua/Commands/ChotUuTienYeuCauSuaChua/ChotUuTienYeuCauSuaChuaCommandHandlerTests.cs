...
namespace HeThongChungCu.Application.UnitTests.Features.YeuCauSuaChua.Commands.ChotUuTienYeuCauSuaChua;

public sealed class ChotUuTienYeuCauSuaChuaCommandHandlerTests : BaseTest
{
    ...
    private readonly ChotUuTienYeuCauSuaChuaCommandHandler _handler;

    public ChotUuTienYeuCauSuaChuaCommandHandlerTests()
    {
        ...
        _handler = new ChotUuTienYeuCauSuaChuaCommandHandler(
            _ycscRepository,
            _canHoRepository,
            _toaNhaRepository,
            _nhanVienRepository,
    ...
    {
        // Arrange
        var request = new ChotUuTienYeuCauSuaChuaCommand(1, MucDoUuTien.Cao.Value);
        ...
        ycsc.MucDoUuTienChotId.Should().Be(MucDoUuTien.Cao);
        ycsc.NguoiChotUuTienId.Should().Be(employee.Id);
    }
