...
public class YeuCauPhuongTienCommandRepository : IYeuCauPhuongTienCommandRepository
{
    ...
    {
        return await _dbContext.YeuCauPhuongTiens
    ...
    {
        return await _dbContext.YeuCauPhuongTiens.AnyAsync(expression, cancellationToken);
    }

    public async Task AddAsync(YeuCauPhuongTien yeuCau, CancellationToken cancellationToken = default)
    {
        await _dbContext.YeuCauPhuongTiens.AddAsync(yeuCau, cancellationToken);
    }

    public void Update(YeuCauPhuongTien yeuCau)
    {
        _dbContext.YeuCauPhuongTiens.Update(yeuCau);
    }

    public void Delete(YeuCauPhuongTien yeuCau)
    {
        _dbContext.YeuCauPhuongTiens.Remove(yeuCau);
    }

    public void DeleteRange(IEnumerable<YeuCauPhuongTien> yeuCaus)
    {
        _dbContext.YeuCauPhuongTiens.RemoveRange(yeuCaus);
    }
}
