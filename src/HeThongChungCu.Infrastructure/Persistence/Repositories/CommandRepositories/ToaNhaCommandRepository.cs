...
public class ToaNhaCommandRepository : IToaNhaCommandRepository
{
    ...
    {
        return await _dbContext.ToaNhas.AnyAsync(t => t.MaToaNha == maToaNha, cancellationToken);
    }
    ...
    {
        await _dbContext.ToaNhas.AddAsync(toaNha, cancellationToken);
    }

    public void Update(ToaNha toaNha)
    {
        _dbContext.ToaNhas.Update(toaNha);
    }
